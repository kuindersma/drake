classdef MomentumQPController < MIMODrakeSystem
  % A QP-based balancing and walking controller that exploits TV-LQR solutions
  % for (time-varing) linear momentum dynamics.  
  methods
  function obj = MomentumQPController(r,body_accel_input_frames,controller_data,options)
...
%       Sdot = 0*S; 
    ...
    if (obj.use_mex==0 || obj.use_mex==2)
      ...
      if nc > 0
        ...
        fqp = (x_bar'*S + 0.5*s1')*B_ls*Iqdd;
        fqp = fqp - u0'*R_ls*Iqdd;
