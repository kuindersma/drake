...
%       typecheck(r,'Biped');
      ...
      robot_state = getStateFrame(r);
      input_frame = robot_state;
      if options.use_actuator_coordinates
        output_frame = MultiCoordinateFrame({r.getInputFrame,robot_state});
      else
        output_frame = MultiCoordinateFrame({LittleDogCoordinates(r),robot_state});
      end
