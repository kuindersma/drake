classdef RobustDirectTrajectoryOptimization < NonlinearProgram
  properties (SetAccess = protected)
    ...
    u_inds  % m x N indices for inputs
  ...
  methods
    function obj = RobustDirectTrajectoryOptimization(plant,N,M,durations,options)
    % function obj =
    ...
    function obj = setupVariables(obj, N)
      ...
      % and N-1 corresponding input variables and disturbances
      % Overwrite to change
      %
      ...
      obj.z_inds = reshape(nH + (nX+nU)*N + nW*N + (1:(N-1)*M),M,N-1);
