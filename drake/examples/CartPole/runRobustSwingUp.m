...
D = (2/2^2); %This corresponds to +/- 2 Newtons of disturbance force
...
%Robust DIRTRAN
[utraj2,xtraj2,z,prog] = p.robustSwingUpTrajectory(D,Q,R,Qf);
...
p.friction_on = 1;
clsys = feedback(c2,p);
[~,xcl2] = clsys.simulate([utraj2.tspan(1) utraj2.tspan(2)], xtraj2.eval(0));
v.playback(xcl2);
